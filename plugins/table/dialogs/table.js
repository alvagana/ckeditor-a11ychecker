...
(function () {
    ...
    function r(a, f) {
        ...
        return {
            ...
            getModel: function (d) {
                return "tableProperties" !== this.dialog.getName() ? null : (d = (d = d.getSelection()) && d.getRanges()[0]) ? d._getTableElement({ table: 1 }) : null;
            },
            onLoad: function () {
                var d = this,
            ...
            onShow: function () {
                ...
                "tableProperties" == f &&
                    ((d = d.getSelectedElement()) && d.is("table") ? (b = d) : 0 < e.length && (CKEDITOR.env.webkit && e[0].shrink(CKEDITOR.NODE_ELEMENT), (b = a.elementPath(e[0].getCommonAncestor(!0)).contains("table", 1))),
            ...
            onOk: function () {
                ...
                if (c.info) {
                    ...
                    if (!this._.selectedElement)
                        for (var h = b.append(p("tbody")), f = parseInt(c.txtRows, 10) || 0, l = parseInt(c.txtCols, 10) || 0, k = 0; k < f; k++) for (var g = h.append(p("tr")), m = 0; m < l; m++) g.append(p("td")).appendBogus();
                    f = c.selHeaders;
                    ...
                    if (!this.hasColumnHeaders && ("col" == f || "both" == f)) for (g = 0; g < b.$.rows.length; g++) (m = new CKEDITOR.dom.element(b.$.rows[g].cells[0])), m.renameNode("th"), m.setAttribute("scope", "row");
